...
import (
	...
	dStub "github.com/morigs/migrate/v4/database/stub"
	"github.com/morigs/migrate/v4/source"
	sStub "github.com/morigs/migrate/v4/source/stub"
)
...
func ExampleNewWithDatabaseInstance() {
	...
	// `import "github.com/morigs/migrate/v4/database/postgres"`
...
func ExampleNewWithSourceInstance() {
	...
	// `import "github.com/morigs/migrate/v4/source/stub"`
